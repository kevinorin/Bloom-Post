	...
	<div id="generate-tabs-container">
		...
		<div class="generate-tab">
			...
			<div id="generate-content-tab" class="generate-tab-content">
				...
				<textarea style="width:100%;min-height:200px;" name="_meta-generate-page-header-content" id="_meta-generate-page-header-content"><?php echo esc_html(generate_page_header_get_post_meta( get_the_ID(), '_meta-generate-page-header-content', true )); ?></textarea>
