...
class GeneratePress_Pro_Typography_Customize_Control extends WP_Customize_Control
{
	...
	public function enqueue() {
		wp_enqueue_script( 'generatepress-pro-typography-select2', trailingslashit( plugin_dir_url( __FILE__ ) )  . 'js/select2.min.js', array( 'customize-controls', 'jquery' ), GP_PREMIUM_VERSION, true );
		wp_enqueue_style( 'generatepress-pro-typography-select2', trailingslashit( plugin_dir_url( __FILE__ ) ) . 'css/select2.min.css', array(), GP_PREMIUM_VERSION );
		
		wp_enqueue_script( 'generatepress-pro-typography-customizer', trailingslashit( plugin_dir_url( __FILE__ ) )  . 'js/typography-customizer.js', array( 'customize-controls', 'generatepress-pro-typography-select2' ), GP_PREMIUM_VERSION, true );
