...
jQuery(document).ready(function($) {
	...
	*/
	...
	function searchCode() {
		...
		if(!myCodeMirror.getSearchCursor(text).findNext()) {
			...
			alert(ed.getLang('wpep_langs.codem_no_match'));
			return false;    
		} 
	...
	function replaceCode() {
		...
		if(!myCodeMirror.getSearchCursor(s_text).findNext()) {
			...
			alert(ed.getLang('wpep_langs.codem_no_replace'));
			return false;    
		}
	...
	*/
	var tagNames = ("a abbr acronym address applet area b base basefont bdo big blockquote body br button" + 
					" caption center cite code col colgroup dd del dfn dir div dl dt em embed fieldset font form frame" +
	...
	var unPairedTags = ("area base basefont br col dd dt embed frame hr img input isindex link meta param").split(" ");
